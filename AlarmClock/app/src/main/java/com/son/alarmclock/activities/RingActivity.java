...
import com.son.alarmclock.databinding.ActivityRingBinding;
import com.son.alarmclock.model.Alarm;
import com.son.alarmclock.service.AlarmService;
...
/*        KeyguardManager keyguardManager=(KeyguardManager)getSystemService(Context.KEYGUARD_SERVICE) ;
    ...
    private void animateClock() {
        ObjectAnimator rotateAnimation = ObjectAnimator
                .ofFloat(ringActivityViewBinding.activityRingClock,
                        "rotation", 0f, 30f, 0f, -30f, 0f);
