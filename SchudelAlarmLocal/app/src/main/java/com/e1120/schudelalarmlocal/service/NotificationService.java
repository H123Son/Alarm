package com.e1120.schudelalarmlocal.service;
...
import com.e1120.schudelalarmlocal.MainActivity;
import com.e1120.schudelalarmlocal.R;
    ...
    public void onHandleIntent(Intent intent) {
        ...
        if (i >= 26) {
            ...
            if (notificationManager2.getNotificationChannel(string) == null) {
                NotificationChannel notificationChannel = new NotificationChannel(string, string, NotificationManager.IMPORTANCE_HIGH);
            ...
            builder.setContentTitle(getString(R.string.app_name))
                    ...
                    .setSound(defaultUri).setContentIntent(PendingIntent.getActivity(applicationContext, 0, intent2,
